                                ...
                                <div class="container justify-content-center align-items-center">
                                    ...
                                    <form action="./control/add.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="textCode" class="form-control" id="" cols="30" rows="4" placeholder="snippets..."></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" name="addSnippets" class="btn btn-primary my-2">Submit</button>
                                        </div>
