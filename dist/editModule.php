                                    ...
                                    ?>
                                            <form action="./control/update.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value=<?= $row['programming_id'] ?> id="language" name="programming_id" placeholder="language_id...">
                                                </div>
                                                <div class="text-center">
                                                    <button type="submit" name="updateModule" class="btn btn-primary my-2">Update</button>
                                                </div>
                                            </form>
                                    <?php
