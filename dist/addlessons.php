                        ...
                        <div class="col-md-5">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT les_tbl.`lesson_name`, les_tbl.`lessons` ,allmodules_tbl.`module_id`FROM allmodules_tbl INNER JOIN les_tbl ON les_tbl.`lesson_id` = allmodules_tbl.`lesson_id` WHERE allmodules_tbl.module_id =  $moduleID  ";
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    ?>
                                                    <td><?= $row['lessons'] ?></td>
                                                    <td><a href="./control/add.php?studentId=<?= $studentID ?>&lesson_id=<?= $row['lesson_id'] ?>&module_id=<?= $moduleID ?>" class="btn btn-primary">Add Lesson</a></td>
