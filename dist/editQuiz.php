                        ...
                        <div class="col-4">
                            <div class="card my-4 p-2">
                                <div class="container justify-content-center align-items-center">
                                    ...
                                    $id = $_GET['id'];
                                    $sql = "SELECT * FROM quiz_tbl where quiz_id = '$id';";
                                    $result = $conn->query($sql);
                                    ...
                                    ?>
                                            <form action="./control/update.php" method="post" enctype="multipart/form-data">
                                                <h3 class="text-info text-center py-4">Edit Quiz</h3>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="date" placeholder="date..." class="form-control my-2" name="started_at"> <?php echo $row['started_at'] ?></textarea>

                                                </div>


                                                <div class="text-center">
                                                    <button type="submit" name="quizUpdate" class="btn btn-primary my-2">Update</button>
                                                </div>
                                            </form>
                                    <?php
