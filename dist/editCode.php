                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="d-flex"><a class="btn btn-danger mx-2 text-white">Delete</a><a class="btn btn-info mx-2 text-white" href="editSub.php?id=<?= $row['sub_lesson_id'] ?>">Edit</a></div>
                                                        </div>
                                                    </td>
                        ...
                        <div class="col-4">
                            <div class="card my-4 p-2">
                                <div class="container justify-content-center align-items-center">
                                    ...
                                    $id = $_GET['id'];
                                    $sql = "SELECT * FROM code where snippets_id = $id;";
                                    $result = $conn->query($sql);
                                    ...
                                    ?>
                                            <form action="./control/update.php" method="post" enctype="multipart/form-data" id="edit">
                                                ...
                                                <h3 class="text-info text-center py-4">Edit Snippets</h3>
                                                <div class="form-group">
                                                    <label for="snippets_id">Snippets_id</label>
                                                    <input type="text" class="form-control" value=<?= $row['snippets_id'] ?> id="snippets_id" name="snippets_id" placeholder="language...">
                                                </div>
                                                <div class="form-group">
                                                    <label for="language">language</label>
                                                    <input type="text" class="form-control" value=<?= $row['language'] ?> id="language" name="language" placeholder="language...">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value=<?= $row['sub_lesson_id'] ?> id="sub_lesson_id" name="sub_lesson_id" placeholder="sub_lesson_id...">
                                                </div>


                                                <div class="text-center">
                                                    <button type="submit" name="updateSnippets" class="btn btn-primary my-2">Update</button>
                                                </div>
